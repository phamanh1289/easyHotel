...
public class FavouritesAdapter extends RecyclerView.Adapter<FavouritesAdapter.HotelHolder> {
    ...
    public FavouritesAdapter(List<InfomationModel> mData) {
        this.mData = mData;
    }
    ...
    class HotelHolder extends RecyclerView.ViewHolder {
        ...
        @BindView(R.id.itemFavourites_tvTitle)
        TextView tvTitle;
        @BindView(R.id.itemFavourites_tvAddress)
        TextView tvAddress;
        @BindView(R.id.itemFavourites_ivBanner)
        ImageView ivBanner;
        @BindView(R.id.item_avLoading)
        AVLoadingIndicatorView avLoading;
        @BindView(R.id.itemFavourites_ivDouble)
        ImageView ivDouble;
        @BindView(R.id.itemFavourites_ivSingle)
        ImageView ivSingle;
        @BindView(R.id.itemFavourites_tvBooking)
        TextView tvBooking;
        @BindView(R.id.itemFavourites_tvPrice)
        TextView tvPrice;
        @BindView(R.id.itemFavourites_tvLike)
        ImageView tvLike;
